...
/**
 * @description Identifier string for the TypeORM adapter flavour.
 * @summary Used to register and resolve the TypeORM implementation within the Decaf.ts adapter factory system.
 * @const TypeORMFlavour
 * @memberOf module:for-typeorm
 */
